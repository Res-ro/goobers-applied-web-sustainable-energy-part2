...
(3, 'Huw', '106515526', 'SQLクエリがバーに入って2つのテーブルに近づき、『一緒に結合できますか？』と尋ねた (A SQL query goes into a bar, walks up to two tables and asks, \'Can I join you?\')', 'Worked on the Jobs page.', 'Dynamically rendered and created jobs and about pages. Worked on Website Security. Created Search Bar for Jobs'),
